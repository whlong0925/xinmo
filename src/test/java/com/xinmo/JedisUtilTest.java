...
public class JedisUtilTest {
        ...
        public void testGet(){
            ...
            jedis.set(SerializeUtils.serialize("admin"),"admin".getBytes());//向key-->name中放入了value-->minxr
            System.out.println(new String(jedis.get(SerializeUtils.serialize("admin"))));
